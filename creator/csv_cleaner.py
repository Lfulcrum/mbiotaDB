...
#        df[time_col] = pd.to_timedelta(df[time_col])
    ...
    for num_col in all_column_types['numeric']:
        ...
        if pd.api.types.is_object_dtype(df[num_col]):  
			# pandas failed to convert str
...
# TODO: Should we go for the more general is_invalid_range?
...
# TODO Write more converter functions!!
